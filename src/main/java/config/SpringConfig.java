...
//        registry.addResourceHandler("/images/**").addResourceLocations("/WEB-INF/images/");
        ...
        //registry.addResourceHandler("/javascript/**").addResourceLocations("/WEB-INF/fcss/javascript/*");        
        // registry.addResourceHandler("/*.xhtml").addResourceLocations("/WEB-INF/xhtml/*");        
