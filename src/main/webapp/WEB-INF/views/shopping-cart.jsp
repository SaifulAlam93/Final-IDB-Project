                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table cart-table">
                                            ...
                                            <c:forEach var="cart" items="${cartlist}">
                                                <tr>
<!--                                                <tr>
                                                    <td><c:out value="$ {cla.id}"/></td>
                                                <td><c:out value="$ {cla.name}"/></td>
                                                <td><c:out value="$ {cla.address}"/></td>
                                                <td class="btn btn-primary"><a href="editClient?id=<c:out value='$ {cla.id}'/>" class="btn btn-primary">Edit</a></td>
                                                <td class="btn btn-danger" ><a href="deleteClient?id=<c:out value='$ {cla.id}'/>" class="btn btn-primary">Delete</a></td>
                                                </tr>-->

                                            <td class="product-name-col">
                                                <figure>
                                                    <a href="#"><img class="img-responsive" src="img/product/${cart.productname}.jpg" alt="White linen sheer dress"></a>
                                                </figure>
                                                <h2 class="product-name"><a href="#">${cart.productname}</a></h2>

                                                <ul>
                                                    <li>Color: <c:out value="${cart.color}"/></li>
                                                    <li>Size: ${cart.size}</li>
                                                </ul>
                                            </td>
                                            <td class="product-code">${cart.productcode}</td>
                                            <td class="product-price-col">
                                                <span class="product-price-special">\$${cart.productcode}</span>
                                            </td>
                                            <td>
